...
@hydra.main(version_base=None, config_path="../configs", config_name="experiment/catboost_experiment")
def main(cfg: DictConfig):
    ...
    if cfg.model.use_cv:
        ...
        with joblib.parallel_backend('sequential', verbose=5):
...
# python src/train_catboost.py experiment.model.use_cv=true